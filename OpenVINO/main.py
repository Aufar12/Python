...
# net = ie.read_network(
#     model="models/Text Detection/horizontal-text-detection-0001.xml",
#     weights="models/Text Detection/horizontal-text-detection-0001.bin",
# )

net = ie.read_network(
    model="models/Face Detection/face-detection-0205.xml",
    weights="models/Face Detection/face-detection-0205.bin",
)
...
image = cv2.imread("data/billboard.jpg")
...
img  =convert_result_to_image(image, resized_image, boxes, conf_labels=True)
cv2.imshow("img", img)
cv2.waitKey()